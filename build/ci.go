...
import (
	...
	"github.com/ABCDEcapital/parallel-go-ethereum/crypto/signify"
	"github.com/ABCDEcapital/parallel-go-ethereum/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/ABCDEcapital/parallel-go-ethereum/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/ABCDEcapital/parallel-go-ethereum/internal/version.gitDate="+env.Date)
	}
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "-ldflags", "-s -w", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/ABCDEcapital/parallel-go-ethereum/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "-ldflags", "-s -w", "--target", "ios", "-v", "github.com/ABCDEcapital/parallel-go-ethereum/mobile")
